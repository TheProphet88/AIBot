...
__all__ = [
    'DISPID_SpeechPhraseRule', 'eLEXTYPE_PRIVATE9', 'SASRun',
    'DISPID_SOTCategory', 'SRTExtendableParse',
    'DISPID_SOTGetDescription', 'DISPID_SAFType', 'SDTAll',
    'SPAS_PAUSE', 'ISpeechRecoResult', 'DISPID_SAFGetWaveFormatEx',
    ...
    'ISpeechRecoGrammar', 'SPWORDPRONUNCIATIONLIST', 'DISPID_SPIRule',
    'ISpeechPhraseReplacements', 'DISPID_SpeechVoice',
    'SDKLDefaultLocation', 'STCInprocHandler', 'SDTProperty',
    'DISPID_SPRText', 'SPAUDIOOPTIONS', 'SVP_16', 'ISpRecoContext2',
    'DISPID_SVEventInterests', 'SINone', 'ISpeechAudioBufferInfo',
    'DISPID_SGRClear', 'DISPID_SPANumberOfElementsInResult',
    'SAFT44kHz8BitMono', 'DISPID_SAFGuid',
    'DISPID_SRGCmdLoadFromMemory', 'SAFT8kHz16BitMono',
    'DISPID_SGRSTNextState', 'DISPID_SVEStreamEnd',
    'DISPID_SRGCmdSetRuleIdState', 'ISpeechRecognizer',
    'SDTReplacement', 'SPEI_RESERVED5', 'DISPID_SRRTStreamTime',
    'SpeechVoiceCategoryTTSRate', 'SpeechCategoryAppLexicons',
    'SECFEmulateResult', 'SpeechAudioState', 'DISPID_SPRsCount',
    'SAFT16kHz16BitStereo', 'SpeechPropertyAdaptationOn',
    'SPRS_ACTIVE_USER_DELIMITED', 'DISPID_SRCEPropertyNumberChange',
    'SPAR_Medium', 'DISPID_SpeechRecognizer', 'SSFMCreateForWrite',
    'DISPID_SpeechPhraseBuilder', 'DISPID_SpeechXMLRecoResult',
    'SAFTGSM610_44kHzMono', 'SVEPrivate',
    'SSSPTRelativeToCurrentPosition', 'SPEI_PHONEME', 'SREStreamEnd',
    'ISpAudio', 'DISPID_SRCRetainedAudioFormat',
    'Speech_Max_Word_Length', 'DISPID_SRCState', 'SGDSActive',
    'ISpRecoGrammar', 'SPLO_STATIC', 'SAFTNoAssignedFormat',
    'STCLocalServer', 'IInternetSecurityManager', 'SREBookmark',
    'ISpStream', 'SPXMLRESULTOPTIONS', 'DISPID_SRCESoundEnd',
    'DISPID_SRCPause', 'SREPropertyNumChange', 'SPDATAKEYLOCATION',
    'STSF_AppData', 'SAFTGSM610_8kHzMono', 'SPPS_Unknown',
    'SWPKnownWordPronounceable', 'eLEXTYPE_RESERVED6', 'SRTStandard',
    'SPEI_ADAPTATION', 'SAFT16kHz16BitMono', 'ISequentialStream',
    'DISPID_SGRsDynamic', 'SAFTCCITT_uLaw_8kHzStereo', 'SRSInactive',
    'SpeechAudioFormatType', 'SpeechAddRemoveWord',
    'SpeechAudioFormatGUIDText', 'DISPID_SPEAudioTimeOffset',
    'SpeechRecognitionType', 'DISPID_SWFEExtraData',
    'ISpeechBaseStream', 'SPSLMA', 'DISPID_SpeechAudioBufferInfo',
    'DISPID_SVSRunningState', 'DISPID_SDKEnumValues', 'SpAudioFormat',
    'DISPID_SPAsItem', 'SPWORDPRONUNCIATION', 'SPADAPTATIONRELEVANCE',
    'SVP_4', 'DISPID_SPPParent', 'DISPID_SOTCEnumerateTokens',
    'DISPID_SRCVoicePurgeEvent',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'SpeechGrammarWordType', 'SGDisplay', 'SPBO_NONE',
    'DISPID_SOTGetAttribute', 'DISPID_SpeechRecoContext',
    'SAFTTrueSpeech_8kHz1BitMono', 'eLEXTYPE_USER_SHORTCUT',
    'SPPHRASEELEMENT', 'SRERecognition', 'SITooQuiet', 'SGSEnabled',
    'SRAInterpreter', 'SPEI_UNDEFINED', 'ISpStreamFormat', 'SVP_10',
    'DISPID_SGRSAddWordTransition', 'ISpRecognizer3', 'SP_VISEME_18',
    'SVPNormal', 'SPRS_INACTIVE', 'SpeechRuleState',
    'SPINTERFERENCE_LATENCY_WARNING', 'SINoise', 'eLEXTYPE_PRIVATE13',
    'SLOStatic', 'DISPID_SLGetWords', 'SVSFParseSapi',
    'SECNormalConfidence', 'SP_VISEME_6', 'SVP_5',
    'eLEXTYPE_PRIVATE19', 'DISPID_SPIGetDisplayAttributes',
    'ISpeechPhraseProperty', 'DISPID_SLWsItem',
    'DISPID_SRCCmdMaxAlternates', 'SAFTCCITT_uLaw_44kHzMono',
    'SLTApp', 'ISpRecoResult', 'DISPID_SLWPronunciations',
    'SVF_Emphasis', 'SPEVENT', 'ISpNotifySink',
    'SpeechVoiceSpeakFlags', 'DISPID_SLWs_NewEnum', 'SPRECOSTATE',
    'DISPID_SRSetPropertyString', 'SAFT8kHz8BitStereo',
    'DISPID_SRRRecoContext', 'SRERequestUI',
    'DISPID_SWFEAvgBytesPerSec', 'DISPID_SLPsCount',
    'DISPID_SRGDictationSetState', 'SREInterference', 'SpObjectToken',
    'DISPID_SPCIdToPhone', 'SpResourceManager',
    'DISPID_SPISaveToMemory', 'SVSFIsNotXML', 'DISPID_SPPConfidence',
    'SpLexicon', 'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'SPEVENTENUM', 'DISPID_SVVoice', 'DISPID_SPRules_NewEnum',
    'SAFT44kHz16BitMono', 'SWTDeleted', 'DISPID_SRGCmdSetRuleState',
    'SPSHT_Unknown', 'SPEI_WORD_BOUNDARY', 'ISpeechObjectToken',
    'SAFTNonStandardFormat', 'SPBO_PAUSE', 'SPINTERFERENCE_NOISE',
    'DISPID_SASetState', 'DISPIDSPTSI_ActiveOffset',
    'DISPID_SGRSTText', 'SRTSMLTimeout', 'SpeechDiscardType',
    'SPEI_END_SR_STREAM', 'SREPrivate', 'DISPID_SRCEInterference',
    'DISPID_SRRAudio', 'SPSERIALIZEDPHRASE',
    'SpeechGrammarTagUnlimitedDictation', 'SP_VISEME_4',
    'SFTSREngine', 'DISPID_SpeechRecoResult', 'SGRSTTDictation',
    'DISPID_SASNonBlockingIO', 'SpeechLexiconType',
    'DISPID_SPPEngineConfidence', 'DISPID_SFSClose',
    'SpeechInterference', 'SpeechDisplayAttributes',
    'DISPID_SGRSAddRuleTransition', 'SpShortcut',
    'DISPID_SRCERecognition', 'SAFT8kHz8BitMono',
    'ISpeechGrammarRules', 'DISPID_SVGetVoices',
    'SAFTCCITT_ALaw_8kHzStereo', 'ISpNotifyTranslator',
    'DISPID_SDKSetLongValue', 'SGRSTTWildcard', 'SPCT_COMMAND',
    'DISPID_SVStatus', 'SPEI_RESERVED3', 'SVP_0', 'DISPID_SVPause',
    'DISPID_SpeechObjectToken', 'SAFTADPCM_11kHzMono',
    'ISpStreamFormatConverter', 'DISPID_SRCResume',
    'SPEI_VOICE_CHANGE', 'SP_VISEME_19', 'DISPID_SPIReplacements',
    'DISPID_SLGenerationId', 'SpMMAudioEnum',
    'DISPIDSPTSI_SelectionLength', 'SpeechRetainedAudioOptions',
    'DISPID_SRRSaveToMemory', 'SPGRAMMARSTATE',
    'SPEI_TTS_AUDIO_LEVEL', 'SP_VISEME_15', 'SSTTTextBuffer',
    'DISPID_SGRSTsItem', 'DISPID_SASCurrentSeekPosition',
    'SPCONTEXTSTATE', 'SPEI_START_SR_STREAM',
    'DISPID_SRGCmdLoadFromObject', 'SPEI_SOUND_START', 'SPAR_Low',
    'SVSFVoiceMask', 'SPEI_SR_AUDIO_LEVEL', 'SPEI_TTS_BOOKMARK',
    'SpeechPropertyHighConfidenceThreshold',
    'DISPID_SGRSTPropertyName', 'SPFM_CREATE', 'SVSFPurgeBeforeSpeak',
    'DISPID_SPPValue', 'SAFT24kHz16BitStereo', 'DISPID_SPPsCount',
    'DISPID_SOTsCount', 'ISpeechPhraseRules',
    'DISPIDSPTSI_SelectionOffset', 'DISPID_SPIRetainedSizeBytes',
    'eLEXTYPE_RESERVED4', 'SAFTADPCM_11kHzStereo',
    'DISPID_SLPSymbolic', 'DISPID_SOTCreateInstance',
    'DISPID_SRRAudioFormat', 'ISpeechPhraseInfo', 'SVP_8',
    'DISPID_SRGRecoContext', 'DISPID_SPCPhoneToId',
    'SpeechPropertyResourceUsage', 'SPINTERFERENCE_TOOSLOW',
    'SSTTWildcard', 'SAFT24kHz8BitStereo',
    'DISPID_SpeechPhraseAlternate', 'DISPID_SPRsItem',
    'SAFT48kHz16BitStereo', 'SPSHORTCUTTYPE', 'SpeechAudioVolume',
    'SRADynamic', 'tagSPTEXTSELECTIONINFO', 'SPINTERFERENCE_TOOLOUD',
    'SP_VISEME_17', 'DISPID_SpeechPhraseAlternates',
    'DISPID_SpeechGrammarRuleStateTransitions', 'DISPID_SPRulesItem',
    'ISpEventSource', 'DISPID_SPPId', 'DISPID_SRCEFalseRecognition',
    'tagSTATSTG', 'eLEXTYPE_PRIVATE14', 'SVP_3',
    'DISPID_SREmulateRecognition', 'eLEXTYPE_VENDORLEXICON',
    'SP_VISEME_20', 'eLEXTYPE_PRIVATE20', 'DISPID_SAEventHandle',
    'DISPID_SVGetAudioInputs', 'eLEXTYPE_PRIVATE5',
    'SPINTERFERENCE_TOOFAST', 'SAFT16kHz8BitMono',
    'SpeechRecoContextState', 'SAFTADPCM_44kHzMono',
    'SPSHT_NotOverriden', 'SRAImport', 'DISPID_SRRTLength',
    '_ISpeechVoiceEvents', 'SPAS_RUN', 'DISPID_SOTIsUISupported',
    'DISPID_SRCRetainedAudio', 'DISPID_SVESentenceBoundary',
    'ISpRecognizer2', 'ISpeechAudio',
    'DISPID_SpeechGrammarRuleStateTransition', 'eLEXTYPE_PRIVATE12',
    'ISpeechRecognizerStatus', 'SAFTADPCM_8kHzMono',
    'SAFT12kHz8BitStereo', 'DISPID_SRAudioInput', 'eLEXTYPE_PRIVATE4',
    'DISPID_SGRSTsCount', 'SPWF_SRENGINE', 'SPPHRASE',
    'DISPID_SDKSetStringValue', 'DISPID_SLPType', 'SVP_13',
    'DISPID_SGRsItem', 'SpeechTokenValueCLSID',
    'DISPID_SpeechPhraseElement', 'SPRS_ACTIVE', 'eLEXTYPE_PRIVATE17',
    'DISPID_SGRSAddSpecialTransition', 'SpeechRunState',
    'SAFTCCITT_ALaw_44kHzStereo', 'ISpPhoneticAlphabetConverter',
    'SP_VISEME_10', 'DISPID_SMSAMMHandle', 'DISPID_SMSSetData',
    'DISPID_SLWLangId', 'SVP_2', 'DISPID_SVPriority',
    'SPRST_INACTIVE', 'SVP_7', 'eLEXTYPE_PRIVATE18', 'DISPID_SRState',
    'SRSEIsSpeaking', 'DISPID_SpeechPhraseProperty',
    'SAFTExtendedAudioFormat', 'DISPID_SOTRemoveStorageFileName',
    'DISPID_SpeechAudio', 'SVSFParseMask', 'DISPID_SVSLastResult',
    'DISPID_SpeechGrammarRuleState', 'DISPID_SVEBookmark',
    'SREAdaptation', 'DISPID_SDKGetlongValue',
    'SpeechSpecialTransitionType', 'SpeechTokenIdUserLexicon',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'DISPID_SCSBaseStream',
    'DISPIDSPTSI_ActiveLength', 'eLEXTYPE_PRIVATE2',
    'ISpRecoGrammar2', 'DISPID_SPPsItem', 'DISPID_SLWsCount', 'SVP_1',
    'SpNotifyTranslator', 'ISpPhraseAlt', 'eLEXTYPE_PRIVATE3',
    'DISPID_SDKDeleteKey', 'DISPID_SOTCSetId', 'SPWT_DISPLAY',
    'STSF_LocalAppData', 'SAFT22kHz8BitMono',
    'DISPID_SAFSetWaveFormatEx', 'DISPID_SPILanguageId',
    'SpStreamFormatConverter', 'ISpeechObjectTokenCategory',
    'SAFTCCITT_uLaw_11kHzStereo', 'ISpeechPhraseAlternate',
    'SPEI_VISEME', 'ISpEventSink', 'SAFTCCITT_uLaw_44kHzStereo',
    'SPEI_MIN_TTS', 'IStream', 'DISPID_SRRTOffsetFromStart',
    'SGDSInactive', 'DISPID_SRGSetWordSequenceData', 'SPAO_NONE',
    'SPEI_SR_PRIVATE', 'DISPID_SRCERecognizerStateChange',
    'ISpRecognizer', 'SPPS_RESERVED4', 'DISPID_SRRGetXMLErrorInfo',
    'eLEXTYPE_USER', 'SVESentenceBoundary', 'SPPS_RESERVED1',
    'SpeechTokenContext', 'SPPS_Interjection', 'DISPID_SGRName',
    'DISPID_SpeechGrammarRule', 'DISPID_SPEEngineConfidence',
    'SpeechWordType', 'ISpPhoneConverter', 'SPCATEGORYTYPE',
    'SPEI_RECOGNITION', 'ISpeechPhraseProperties', 'DISPID_SOTRemove',
    'IEnumString', 'Speech_Default_Weight', 'DISPID_SVResume',
    'STSF_FlagCreate', 'DISPID_SPEActualConfidence',
    'DISPID_SPRuleNumberOfElements', 'DISPID_SVSkip',
    'DISPID_SRGetFormat', 'DISPID_SGRSTPropertyValue',
    'SpeechRecoEvents', 'DISPID_SLPLangId', 'DISPID_SGRInitialState',
    'SPEI_RECO_OTHER_CONTEXT', 'SGLexical',
    'DISPID_SpeechLexiconWords', 'SPVPRI_OVER',
    'SpeechPropertyResponseSpeed', 'SAFT22kHz8BitStereo',
    '_RemotableHandle', 'DISPID_SRCVoice', 'DISPID_SRCEAudioLevel',
    'DISPID_SASState', 'SpeechUserTraining', 'SAFT48kHz16BitMono',
    'DISPID_SGRs_NewEnum', 'DISPID_SVRate', 'DISPID_SGRsFindRule',
    'DISPID_SVSInputSentencePosition', 'SECFDefault',
    'DISPID_SVSCurrentStreamNumber', 'DISPID_SBSWrite',
    'SPPS_Noncontent', 'SVSFIsFilename', 'DISPID_SRCESoundStart',
    'DISPID_SVSInputSentenceLength', 'SAFT12kHz16BitStereo',
    'DISPID_SPIProperties', 'DISPID_SPIEnginePrivateData',
    'SpPhoneConverter', 'DISPID_SAStatus', 'ISpeechRecoContext',
    'DISPID_SABufferInfo', 'SVF_Stressed',
    'DISPID_SVSInputWordPosition', 'SPLO_DYNAMIC',
    'DISPID_SWFEChannels', 'SWPUnknownWordUnpronounceable',
    'DISPID_SpeechRecoResult2', 'SAFT11kHz8BitMono',
    'SpeechCategoryAudioOut', 'DISPID_SVSpeakStream',
    'SVEEndInputStream', 'DISPID_SABIMinNotification', 'SPWORDLIST',
    'SPAO_RETAIN_AUDIO', 'DISPID_SOTCGetDataKey', 'DISPID_SPRuleName',
    'DISPID_SpeechLexicon', 'DISPID_SGRSTPropertyId',
    'SPSTREAMFORMATTYPE', 'SpeechPropertyLowConfidenceThreshold',
    'eWORDTYPE_ADDED', 'DISPID_SPPName',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'DISPID_SGRAddState',
    'SP_VISEME_2', 'DISPID_SVSpeakCompleteEvent',
    'DISPID_SDKEnumKeys', 'DISPID_SVIsUISupported',
    'DISPID_SPRNumberOfElements', 'DISPID_SABIEventBias', 'SPAR_High',
    'DISPID_SRDisplayUI', 'DISPID_SPEDisplayAttributes',
    'DISPID_SRSCurrentStreamNumber', 'DISPID_SRRGetXMLResult',
    'SSSPTRelativeToStart', 'STSF_CommonAppData', 'SPPS_LMA',
    'UINT_PTR', 'SVP_6', 'DISPID_SpeechAudioStatus',
    'DISPID_SRCAudioInInterferenceStatus', 'SPSEMANTICERRORINFO',
    'DISPID_SPIGrammarId', 'DISPID_SRGDictationLoad',
    'DISPID_SVSPhonemeId', 'SRTReSent', 'SITooLoud',
    'SAFT12kHz16BitMono', 'SAFT32kHz8BitMono', 'SRARoot',
    'DISPID_SRGReset', 'ISpRecoCategory', 'DISPID_SABIBufferSize',
    'SpeechGrammarRuleStateTransitionType', 'DISPID_SRGetRecognizers',
    'DISPID_SVSLastBookmarkId', 'DISPID_SRCEAdaptation',
    'SpeechEngineConfidence', 'SpeechGrammarTagDictation',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'SpeechTokenKeyFiles',
    'ISpeechWaveFormatEx', 'DISPID_SpeechBaseStream',
    'SRSActiveAlways', 'SGDSActiveUserDelimited', 'eLEXTYPE_APP',
    'SpeechRecoProfileProperties', 'DISPID_SGRSTType',
    'SAFT11kHz16BitMono', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    'DISPID_SpeechFileStream', 'DISPID_SpeechRecognizerStatus',
    'DISPID_SOTCId', 'SPAUDIOSTATUS', 'SP_VISEME_11',
    'DISPID_SpeechRecoContextEvents', 'SAFT8kHz16BitStereo',
    'SPFM_OPEN_READWRITE', 'ISpDataKey',
    'DISPID_SOTMatchesAttributes', 'DISPID_SpeechVoiceStatus',
    'SECLowConfidence', 'DISPID_SPERequiredConfidence', 'SVPOver',
    'IEnumSpObjectTokens', 'SPRST_NUM_STATES', 'DISPID_SRRSpeakAudio',
    'SPEI_MIN_SR', 'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'SPEI_SR_RETAINEDAUDIO', 'eWORDTYPE_DELETED',
    'SpPhraseInfoBuilder', 'SPWF_INPUT', 'ISpeechVoice',
    'DISPID_SpeechObjectTokens', 'ISpNotifySource',
    'DISPID_SGRAddResource', 'SAFTCCITT_ALaw_11kHzStereo',
    'STCRemoteServer', 'SpeechVisemeType', 'SECFIgnoreWidth',
    'ISpeechTextSelectionInformation', 'DISPID_SpeechDataKey',
    'DISPID_SDKCreateKey', 'DISPID_SOTsItem', 'SASPause',
    'DISPID_SPIGetText', 'DISPID_SpeechPhraseReplacement',
    'SVSFIsXML', 'ISpRecoContext', 'DISPID_SRGCmdLoadFromResource',
    'DISPID_SRGCmdLoadFromFile', 'SPEI_SENTENCE_BOUNDARY',
    'DISPID_SRRTimes', 'DISPID_SPAsCount', 'SAFTCCITT_uLaw_22kHzMono',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'SpSharedRecognizer',
    'SPRULESTATE', 'SPRECORESULTTIMES',
    'DISPID_SLAddPronunciationByPhoneIds',
    'SpeechCategoryRecognizers', 'SSFMCreate', 'SPGS_DISABLED',
    'SPEI_START_INPUT_STREAM', 'SPEI_RESERVED6', 'SPPROPERTYINFO',
    'SVEVoiceChange', 'ISpeechGrammarRuleStateTransitions',
    'SECHighConfidence', 'SPAS_CLOSED', 'DISPID_SPEsItem',
    'DISPID_SPELexicalForm', 'SAFT24kHz16BitMono', 'SPINTERFERENCE',
    'SPEI_SR_BOOKMARK', 'DISPID_SGRsAdd', 'ISpVoice',
    'DISPID_SRCBookmark', 'SPGS_ENABLED', 'ISpMMSysAudio',
    'DISPID_SWFEFormatTag', 'SGRSTTRule', 'SGLexicalNoSpecialChars',
    'tagSPPROPERTYINFO', 'SGSDisabled', 'SLTUser', 'SPPS_RESERVED2',
    'DISPID_SPEsCount', 'SDTDisplayText', 'SVSFlagsAsync', 'SVP_12',
    'SAFTADPCM_44kHzStereo', 'SECFIgnoreKanaType', 'SPSFunction',
    'DISPID_SRSNumberOfActiveRules', 'SPINTERFERENCE_NONE',
    'SPEI_MAX_TTS', 'DISPID_SpeechPhraseInfo', 'DISPID_SPAs_NewEnum',
    'DISPID_SPRFirstElement', 'DISPID_SRGIsPronounceable',
    'SPEI_PHRASE_START', 'SPSHORTCUTPAIRLIST',
    'DISPID_SRIsUISupported', 'SRAExport', 'SSSPTRelativeToEnd',
    'SRESoundEnd', 'DISPID_SRCEEnginePrivate',
    'DISPID_SpeechVoiceEvent', 'SPRULE', 'SVEAudioLevel',
    'DISPID_SPPBRestorePhraseFromMemory',
    'DISPID_SOTGetStorageFileName', 'DISPID_SRCEPhraseStart',
    'SPXRO_Alternates_SML', 'DISPID_SDKSetBinaryValue',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'SPVPRIORITY',
    'SPSHORTCUTPAIR', 'ISpeechGrammarRuleState', 'DISPIDSPTSI',
    'SPINTERFERENCE_NOSIGNAL', 'SREHypothesis', 'SpCompressedLexicon',
    'ISpeechPhraseRule', 'SPSHT_EMAIL', 'SPEI_REQUEST_UI',
    'DISPID_SASCurrentDevicePosition', 'SpeechCategoryAudioIn',
    'DISPID_SRSSupportedLanguages', 'SpeechRegistryLocalMachineRoot',
    'DISPID_SRGId', 'DISPID_SRRPhraseInfo', 'SAFT22kHz16BitMono',
    'DISPID_SPEDisplayText', 'SAFT32kHz8BitStereo',
    'SPEVENTSOURCEINFO', 'SPRECOCONTEXTSTATUS', 'SVP_21',
    'SpUnCompressedLexicon', 'DISPID_SGRAttributes',
    'SDKLCurrentUser', 'SPBOOKMARKOPTIONS', 'SAFT48kHz8BitStereo',
    'SPBINARYGRAMMAR', 'DISPID_SPEAudioSizeTime', '_SPAUDIOSTATE',
    'SPGRAMMARWORDTYPE', 'ISpeechPhoneConverter',
    '_ISpeechRecoContextEvents', 'DISPID_SPRuleFirstElement',
    'SVP_15', 'SPVISEMES', 'SpWaveFormatEx',
    'IInternetSecurityMgrSite', 'eLEXTYPE_PRIVATE6', 'ISpeechLexicon',
    'SDTAlternates', 'DISPID_SRIsShared', 'SpeechRuleAttributes',
    'DISPID_SOTId', 'SDTLexicalForm', 'DISPID_SRGetPropertyNumber',
    'DISPID_SPRs_NewEnum', 'SDTRule', 'SVP_11', 'DISPID_SGRSTRule',
    'DISPID_SpeechGrammarRules', 'DISPID_SRSClsidEngine',
    'SPPHRASEPROPERTY', 'DISPID_SpeechMMSysAudio',
    'SDKLCurrentConfig', 'DISPID_SPRDisplayAttributes',
    'ISpeechGrammarRule', 'ISpeechRecoResult2', 'SVSFParseSsml',
    'DISPID_SRCEStartStream', 'DISPID_SLAddPronunciation',
    'SpeechTokenKeyUI', 'SAFTCCITT_ALaw_22kHzStereo',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'SPPS_Modifier',
    'DISPID_SRCSetAdaptationData', 'SPEI_INTERFERENCE',
    'SpeechCategoryRecoProfiles', 'SAFTCCITT_ALaw_8kHzMono',
    'DISPID_SVSVisemeId', 'eLEXTYPE_RESERVED8',
    'SpeechWordPronounceable', 'SPFM_CREATE_ALWAYS',
    'DISPID_SRRecognizer', 'SpeechGrammarState', 'SPSUnknown',
    'DISPID_SWFEBitsPerSample', 'SRADefaultToActive',
    'DISPID_SRCCreateResultFromMemory', 'SVSFPersistXML',
    'ISpLexicon', 'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'SP_VISEME_1',
    'DISPID_SASFreeBufferSpace', 'SPFILEMODE',
    'SpTextSelectionInformation', 'SRATopLevel',
    'DISPID_SpeechPhoneConverter', 'SpeechCategoryPhoneConverters',
    'SAFTGSM610_11kHzMono', 'SPSEMANTICFORMAT', 'DISPID_SOTDisplayUI',
    'SPSHT_OTHER', 'SPSInterjection', 'DISPID_SDKOpenKey',
    'DISPID_SRCRequestedUIType', 'SREPhraseStart',
    'DISPID_SLGetPronunciations', 'ISpeechFileStream',
    'DISPID_SPEs_NewEnum', 'DISPID_SLWType',
    'DISPID_SpeechPhraseProperties', 'DISPID_SFSOpen',
    'ISpPhoneticAlphabetSelection', 'ISpObjectToken',
    'SDKLLocalMachine', 'DISPID_SGRSTWeight', 'ISpeechPhraseElement',
    'DISPID_SpeechLexiconPronunciation', 'STCAll', 'SGSExclusive',
    'SPCT_SUB_COMMAND', 'SpVoice', 'DISPID_SpeechLexiconProns',
    'SpSharedRecoContext', 'ISpXMLRecoResult', 'SPPARTOFSPEECH',
    'SAFTCCITT_ALaw_22kHzMono', 'SPPS_Verb',
    'DISPID_SRCEventInterests', 'DISPID_SPIAudioSizeBytes',
    'SpeechTokenKeyAttributes', 'SPEI_TTS_PRIVATE', 'SVEViseme',
    'SpMemoryStream', 'DISPID_SRCERequestUI', 'SPAUDIOSTATE',
    'eLEXTYPE_PRIVATE15', 'SAFTGSM610_22kHzMono', 'SPWAVEFORMATTYPE',
    'SPWORD', 'DISPID_SPRuleId', 'SpeechVisemeFeature',
    'DISPID_SpeechObjectTokenCategory',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'DISPID_SPIAudioStreamPosition',
    'SVP_14', 'SpeechDataKeyLocation', 'SPWT_LEXICAL',
    'SRAORetainAudio', 'DISPID_SRCEHypothesis', 'SAFT24kHz8BitMono',
    'SPSVerb', 'DISPID_SRSAudioStatus', 'SpeechAudioProperties',
    'ISpeechMemoryStream', 'ISpeechPhraseElements',
    'SpeechEmulationCompareFlags', 'SAFT11kHz16BitStereo',
    'ISpeechVoiceStatus', 'SAFTCCITT_uLaw_8kHzMono', 'SVP_9',
    'SVP_20', 'DISPID_SMSALineId', 'ISpeechAudioStatus',
    'SpeechEngineProperties', 'SAFTADPCM_8kHzStereo', 'SRCS_Disabled',
    'SPEI_HYPOTHESIS', 'SpeechPropertyComplexResponseSpeed',
    'DISPID_SRRDiscardResultInfo', 'SPWT_PRONUNCIATION',
    'SVEStartInputStream', 'SpeechBookmarkOptions',
    'DISPID_SPRuleChildren', 'DISPID_SpeechCustomStream', 'SPAS_STOP',
    'SPPS_Noun', 'ISpeechObjectTokens', 'SAFTCCITT_ALaw_11kHzMono',
    'SVP_17', 'DISPID_SAVolume', 'DISPID_SADefaultFormat',
    'SPSMF_SRGS_SAPIPROPERTIES', 'DISPID_SVEPhoneme',
    'DISPID_SLGetGenerationChange', 'ISpProperties',
    'SGDSActiveWithAutoPause', 'SPEI_RESERVED2', 'SPLEXICONTYPE',
    'SpeechPartOfSpeech', 'SAFTADPCM_22kHzStereo',
    'ISpeechXMLRecoResult', 'DISPID_SGRsCount', 'eLEXTYPE_PRIVATE11',
    'DISPID_SVVolume', 'SAFTText', 'DISPID_SRCEBookmark',
    'DISPID_SpeechMemoryStream', 'SPRST_ACTIVE', 'SPFM_OPEN_READONLY',
    'DISPID_SVEEnginePrivate', 'SPSMF_SAPI_PROPERTIES',
    'SpeechStreamFileMode', 'SDA_One_Trailing_Space',
    'DISPID_SVEWord', 'SpeechAudioFormatGUIDWave', 'DISPID_SGRId',
    'DISPID_SPARecoResult', 'SREFalseRecognition', 'SPCS_DISABLED',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'SP_VISEME_9', 'SVP_19',
    'SPEI_RECO_STATE_CHANGE', 'SpInprocRecognizer', 'DISPID_SLPsItem',
    'SDA_Consume_Leading_Spaces', 'ISpeechDataKey',
    'DISPID_SPIStartTime', 'SECFNoSpecialChars', 'WAVEFORMATEX',
    'SP_VISEME_14', 'SREAllEvents', 'SITooSlow', 'SECFIgnoreCase',
    'SPTEXTSELECTIONINFO', 'SRSActive', 'SpeechVoiceEvents',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'SPCT_DICTATION', 'SVEPhoneme',
    'SpeechStreamSeekPositionType', 'ISpResourceManager',
    'DISPID_SRRSetTextFeedback', 'SFTInput', 'DISPID_SOTDataKey',
    'DISPID_SLPPhoneIds', 'SP_VISEME_21', 'DISPID_SBSRead',
    'DISPID_SPEAudioSizeBytes', 'DISPID_SOTSetId',
    'DISPID_SVGetAudioOutputs', 'SGRSTTWord', 'SVF_None',
    'DISPID_SPPChildren', 'ISpSerializeState', 'SAFT12kHz8BitMono',
    'DISPID_SPRuleConfidence', 'DISPID_SPAStartElementInResult',
    'SPPS_RESERVED3', 'SPDKL_DefaultLocation', 'SVEWordBoundary',
    'DISPID_SDKDeleteValue', 'DISPID_SPIAudioSizeTime',
    'SP_VISEME_13', 'ISpeechRecoResultDispatch', 'DISPID_SRGRules',
    'SpObjectTokenCategory', 'SPEI_RESERVED1',
    'DISPID_SVWaitUntilDone', 'DISPID_SPIElements',
    'DISPID_SPPs_NewEnum', 'SpeechDictationTopicSpelling',
    'SPDKL_CurrentUser', 'DISPID_SGRSTransitions',
    'Speech_StreamPos_Asap', 'DISPID_SPRulesCount',
    'SPSERIALIZEDRESULT', 'eLEXTYPE_MORPHOLOGY', 'SSFMOpenForRead',
    'eLEXTYPE_RESERVED10', 'SDTPronunciation', 'eLEXTYPE_RESERVED7',
    'SP_VISEME_8', 'SASClosed', 'SPEI_PROPERTY_NUM_CHANGE',
    'ISpeechRecoResultTimes', 'DISPID_SRGState', 'SLODynamic',
    'Speech_Max_Pron_Length', 'SSFMOpenReadWrite',
    'SPWORDPRONOUNCEABLE', 'ISpeechResourceLoader',
    'DISPID_SRGDictationUnload', 'DISPID_SBSSeek',
    'DISPID_SRCEEndStream', 'DISPID_SRAudioInputStream',
    'DISPID_SPERetainedStreamOffset', 'SpeechVoicePriority',
    'SPPHRASEREPLACEMENT', 'SPCT_SLEEP', 'DISPID_SPACommit',
    'DISPID_SPPNumberOfElements', 'DISPID_SPPFirstElement',
    'SAFT16kHz8BitStereo', 'SpeechFormatType',
    '__MIDL_IWinTypes_0009', 'DISPID_SVEStreamStart',
    'DISPID_SBSFormat', 'SVSFUnusedFlags', 'SPEI_SOUND_END',
    'ISpeechPhraseInfoBuilder', 'eLEXTYPE_LETTERTOSOUND', 'SITooFast',
    'SPDKL_LocalMachine', 'SP_VISEME_5', 'DISPID_SpeechAudioFormat',
    'SRESoundStart', 'DISPID_SOTs_NewEnum',
    'SpeechVoiceSkipTypeSentence', 'SpCustomStream', 'SSTTDictation',
    'SPEI_MAX_SR', 'SpMMAudioOut', 'SpFileStream', 'SpStream',
    'SWTAdded', 'DISPID_SpeechWaveFormatEx', 'SREStateChange',
    'SpNullPhoneConverter', 'LONG_PTR', 'DISPIDSPRG',
    'SpeechLoadOption', 'DISPID_SVSLastBookmark',
    'SAFTCCITT_ALaw_44kHzMono', 'SPCT_SUB_DICTATION',
    'DISPID_SRRTTickCount', 'DISPID_SWFESamplesPerSec',
    'DISPID_SLPPartOfSpeech', 'SBOPause', 'SpeechAllElements',
    'ISpeechPhraseReplacement', 'ISpeechMMSysAudio',
    'ISpeechLexiconPronunciation', 'SVSFParseAutodetect',
    'ISpGrammarBuilder', 'SpMMAudioIn', 'DISPID_SRStatus',
    'SDA_Two_Trailing_Spaces', 'eLEXTYPE_PRIVATE16', 'SRTAutopause',
    'SPSNoun', 'DISPID_SMSGetData', 'SREPropertyStringChange',
    'DISPID_SpeechPhraseReplacements', 'SPBO_TIME_UNITS',
    'DISPID_SPRuleEngineConfidence', 'SPEI_PROPERTY_STRING_CHANGE',
    'DISPID_SGRsCommit', 'SREAudioLevel', 'ISpPhrase',
    'DISPID_SPAPhraseInfo', 'SPSNotOverriden', 'SRERecoOtherContext',
    'SINoSignal', 'SVP_18', 'SP_VISEME_16', 'SAFT22kHz16BitStereo',
    'DISPID_SLRemovePronunciationByPhoneIds', 'DISPID_SRCRecognizer',
    'SGRSTTEpsilon', 'DISPID_SVSLastStreamNumberQueued',
    'DISPID_SVGetProfiles', 'DISPID_SVEViseme', 'SPPS_NotOverriden',
    'DISPID_SMSADeviceId', 'SAFT48kHz8BitMono',
    'DISPID_SPEPronunciation', 'SpPhoneticAlphabetConverter',
    'SGRSTTTextBuffer', 'SPWORDTYPE', 'SPFM_NUM_MODES',
    'ISpObjectTokenCategory', 'DISPID_SWFEBlockAlign', 'SASStop',
    'DISPID_SRCERecognitionForOtherContext', 'DISPID_SPRuleParent',
    'DISPID_SLPs_NewEnum', 'SPDKL_CurrentConfig', 'DISPID_SGRSRule',
    'DISPID_SGRSTs_NewEnum', 'SPBO_AHEAD', 'SRCS_Enabled',
    'DISPID_SRCreateRecoContext', 'SP_VISEME_3',
    'SpeechCategoryVoices', 'SPXRO_SML', 'SPSSuppressWord',
    'SDA_No_Trailing_Space', 'DISPID_SpeechLexiconWord',
    'eLEXTYPE_RESERVED9', 'SAFT32kHz16BitMono', 'SP_VISEME_12',
    'DISPID_SRGCommit', 'DISPID_SVAudioOutput', 'SPPS_Function',
    'eLEXTYPE_PRIVATE7', 'SRTEmulated', 'ISpShortcut', 'SP_VISEME_0',
    'SWPUnknownWordPronounceable', 'SPAR_Unknown',
    'SAFT44kHz8BitStereo', 'DISPID_SLRemovePronunciation',
    'SPVPRI_ALERT', 'SpeechMicTraining',
    ...
    'SpInProcRecoContext', 'SVEAllEvents', 'SBONone',
    'DISPID_SLWWord', 'DISPID_SPCLangId', 'DISPID_SpeechPhraseRules',
    'SPCS_ENABLED', 'SpeechTokenShellFolder', 'SVSFNLPSpeakPunc',
    'SAFT44kHz16BitStereo', 'ISpObjectWithToken',
    'SpeechRegistryUserRoot', 'SAFTCCITT_uLaw_22kHzStereo',
    'SpeechPropertyNormalConfidenceThreshold', 'SP_VISEME_7',
    'SPPS_SuppressWord', 'SRSInactiveWithPurge',
    'DISPID_SVEVoiceChange', 'DISPID_SVAlertBoundary',
    'SPVPRI_NORMAL', 'SDTAudio', 'SPLOADOPTIONS',
    'DISPID_SVAudioOutputStream', 'DISPID_SPERetainedSizeBytes',
    'ISpeechLexiconPronunciations', 'DISPID_SRGSetTextSelection',
    'DISPID_SDKGetStringValue', 'SVPAlert',
    'DISPID_SDKGetBinaryValue', 'DISPID_SRSCurrentStreamPosition',
    'DISPID_SPIEngineId', 'ISpeechLexiconWords', 'ISpeechAudioFormat',
    'DISPID_SPEAudioStreamOffset', 'STCInprocServer',
    'ISpeechCustomStream', 'DISPID_SpeechPhraseElements',
    'SVEBookmark', 'SRSEDone', 'SAFTDefault', 'SPGS_EXCLUSIVE',
    'SPEI_END_INPUT_STREAM', 'SRAONone', 'SPEI_FALSE_RECOGNITION',
    'SPRST_ACTIVE_ALWAYS', 'DISPID_SpeechRecoResultTimes',
    'SpeechRecognizerState', 'SAFT32kHz16BitStereo',
    'SAFTCCITT_uLaw_11kHzMono', 'ISpeechPhraseAlternates',
    'SPSModifier', 'DISPID_SRCCreateGrammar', 'SGPronounciation',
    'SPINTERFERENCE_TOOQUIET', 'SPSMF_UPS', 'SPVOICESTATUS',
    'DISPID_SVDisplayUI', 'SAFTADPCM_22kHzMono',
    'DISPID_SRRAlternates', 'SpeechGrammarTagWildcard',
    'DISPID_SOTCDefault', 'SAFT11kHz8BitStereo', 'SVSFNLPMask',
    'SPRECOGNIZERSTATUS', 'DISPID_SRProfile',
    'DISPID_SVSyncronousSpeakTimeout',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet', 'SVSFDefault',
    'DISPID_SGRsCommitAndSave', 'eLEXTYPE_PRIVATE8',
    'ISpeechLexiconWord', 'DISPID_SVSpeak',
    'SPRST_INACTIVE_WITH_PURGE'
]

_check_version('1.2.0', 1641632914.272526)
